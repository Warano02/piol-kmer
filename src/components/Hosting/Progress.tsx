...
function Progress() {
    ...
    return (
        <section className="w-full h-[90px] fixed bottom-0">
            <div className="w-full h-full relative  flex flex-col">
                ...
                <div className="w-full h-[80px] flex justify-between items-center px-8">
                    ...
                    <button onClick={() => handleNextStep} className="px-8 py-4 rounded-xl bg-black text-white text-2xl font-bold cursor-pointer h">Next</button>
                </div>
            </div>
        </section>
    )
